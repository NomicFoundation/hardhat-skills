...
Phase 5 of the V2→V3 migration. Follow [migration-conventions.md](../hardhat-v2-to-v3-migration/references/migration-conventions.md) first.
...
- [troubleshooting.md](../hardhat-v2-to-v3-migration/references/troubleshooting.md) — common errors
